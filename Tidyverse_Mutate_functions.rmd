...
### <b>geom_point with color</b>
To add color for a categorical variable in a plot add color = to the aesthetic. 

```{r}
#adding color for a categorical va
ggplot(data=sales_df, aes(x=Age, y=Purchase, color=Gender)) + geom_point() 
```
